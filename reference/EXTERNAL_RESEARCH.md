...
| [emuyia/ems-octakit](https://github.com/emuyia/ems-octakit) | file-format | Browser patcher for OS 1.40C that swaps 4 Parts/Bank for 256 Kits/Project — deep Part/Bank serialization + concrete 1.40C image offsets. → [`kb/file-format.md`](kb/file-format.md) |
| [bryantysinger/octa-bt-pt](https://github.com/bryantysinger/octa-bt-pt) | ColdFire | Parameter-default patch tool (OS 1.40C, Python/Streamlit). Locations of default-value tables in the MAIN OS image. → [`kb/memory-map.md`](kb/memory-map.md) |
