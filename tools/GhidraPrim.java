...
public class GhidraPrim extends GhidraScript {
    DecompInterface dec;
    ...
    public void run() throws Exception {
        ...
        Address a = sp.getAddress(0x400158ccL);
        Function root = fm.getFunctionContaining(a);
        if (root == null) { disassemble(a); root = createFunction(a, "flash_write_primitive"); }
        if (root == null) { println("[!] no hay funcion en 0x40063660"); return; }
        try { root.setName("flash_write_primitive", ghidra.program.model.symbol.SourceType.USER_DEFINED); } catch (Exception e) {}
