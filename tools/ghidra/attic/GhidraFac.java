...
public class GhidraFac extends GhidraScript {
    DecompInterface dec;
    ...
    public void run() throws Exception {
        ...
        Address a = sp.getAddress(0x40015e28L);
        Function root = fm.getFunctionContaining(a);
        if (root == null) { disassemble(a); root = createFunction(a, "flash_driver_factory"); }
        if (root == null) { println("[!] no hay funcion en 0x40063660"); return; }
        try { root.setName("flash_driver_factory", ghidra.program.model.symbol.SourceType.USER_DEFINED); } catch (Exception e) {}
