...
public class GhidraDisp extends GhidraScript {
    DecompInterface dec;
    ...
    public void run() throws Exception {
        ...
        Address a = sp.getAddress(0x40015098L);
        Function root = fm.getFunctionContaining(a);
        if (root == null) { disassemble(a); root = createFunction(a, "queue_dispatch"); }
        if (root == null) { println("[!] no hay funcion en 0x40063660"); return; }
        try { root.setName("queue_dispatch", ghidra.program.model.symbol.SourceType.USER_DEFINED); } catch (Exception e) {}
