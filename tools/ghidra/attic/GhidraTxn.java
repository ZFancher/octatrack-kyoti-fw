...
public class GhidraTxn extends GhidraScript {
    DecompInterface dec;
    ...
    public void run() throws Exception {
        ...
        Address a = sp.getAddress(0x4001568cL);
        Function root = fm.getFunctionContaining(a);
        if (root == null) { disassemble(a); root = createFunction(a, "hw_transaction"); }
        if (root == null) { println("[!] no hay funcion en 0x40063660"); return; }
        try { root.setName("hw_transaction", ghidra.program.model.symbol.SourceType.USER_DEFINED); } catch (Exception e) {}
