...
public class GhidraOsUpgrade extends GhidraScript {
    DecompInterface dec;
    ...
    public void run() throws Exception {
        ...
        Address a = sp.getAddress(0x40063660L);
        Function root = fm.getFunctionContaining(a);
        if (root == null) { disassemble(a); root = createFunction(a, "os_upgrade"); }
        if (root == null) { println("[!] no hay funcion en 0x40063660"); return; }
        try { root.setName("os_upgrade", ghidra.program.model.symbol.SourceType.USER_DEFINED); } catch (Exception e) {}
