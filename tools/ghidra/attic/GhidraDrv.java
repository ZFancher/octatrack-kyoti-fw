...
public class GhidraDrv extends GhidraScript {
    DecompInterface dec;
    ...
    public void run() throws Exception {
        ...
        Address a = sp.getAddress(0x400616a6L);
        Function root = fm.getFunctionContaining(a);
        if (root == null) { disassemble(a); root = createFunction(a, "flash_driver_init"); }
        if (root == null) { println("[!] no hay funcion en 0x40063660"); return; }
        try { root.setName("flash_driver_init", ghidra.program.model.symbol.SourceType.USER_DEFINED); } catch (Exception e) {}
