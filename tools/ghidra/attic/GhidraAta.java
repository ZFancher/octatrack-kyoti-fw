...
public class GhidraAta extends GhidraScript {
    DecompInterface dec;
    ...
    public void run() throws Exception {
        ...
        Address a = sp.getAddress(0x40014c48L);
        Function root = fm.getFunctionContaining(a);
        if (root == null) { disassemble(a); root = createFunction(a, "ata_write_sectors"); }
        if (root == null) { println("[!] no hay funcion en 0x40063660"); return; }
        try { root.setName("ata_write_sectors", ghidra.program.model.symbol.SourceType.USER_DEFINED); } catch (Exception e) {}
