// FUN_40099680(type,slot) = "finalize loaded slot" (loop en el done de carga). Ver si
// perturba una voz de recorder sonando (slots 0x80-0x87). Y FUN_40099374 (subyacente).
//@category Octatrack
...
public class GhidraFinalize extends GhidraScript {
    @Override
    public void run() throws Exception {
        long[] anchors = { 0x40099680L, 0x40099374L, 0x400238a4L };
        String[] labels = { "finalize_99680", "finalize_impl_99374", "resync_238a4" };
